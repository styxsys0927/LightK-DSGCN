################ Ablation study: without temporal convolution ################
...
class ncDSGCN(nn.Module):
    ...
    def loop(self, inputs):
        ...
        inputs_t = inputs # batch_size*time*detector -> batch_size*detector*time
